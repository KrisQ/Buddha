...
if (isset($_POST['edit_post'])) {
  ...
  <strong>Well done!</strong> You successfully edited your Post <a href="#" class="alert-link"></a>.
</div>';
...
?>
  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <img width="100" style='border-radius:12px' src="../images/<?php echo $post_image ?>">
    </div>
